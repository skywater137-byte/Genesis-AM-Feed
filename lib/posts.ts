...
export const POSTS: Post[] = [
  {
    ...
    weight: 9820,
    body: "Liquidity is finally unified. Posting from Base, reading replies from Solana holders in the same thread. This is what cross-chain social was supposed to feel like.",
    upvotes: 1284,
    downvotes: 12,
    recasts: 312,
    recast: false,
  ...
  },
  {
    ...
    weight: 1420,
    body: "The Live Holders Only toggle is genuinely the killer feature. Flip it on and every exited paper-hand vanishes from the timeline instantly.",
    upvotes: 564,
    downvotes: 8,
    recasts: 97,
    recast: false,
  ...
  },
  {
    ...
    weight: 0,
    body: "Dumped my whole Genesis bag at the local top, ngl. Still lurking here though. Watch this post vanish the second someone flips on Live Holders Only.",
    upvotes: 24,
    downvotes: 311,
    recasts: 3,
    recast: false,
  },
  {
    ...
    weight: 1670,
    body: "Shipped a cross-chain tipping prototype this weekend that reads the same holder graph Genesis uses. Open-sourcing soon.",
    upvotes: 472,
    downvotes: 6,
    recasts: 130,
    recast: false,
